...
/**
 * 
 * @ClassName: RefusedJoinTeamController
 * @Description:拒接加入队伍表示层
 * @author: while_box
 * @date: 2017年9月22日 上午10:00:02
 * 注意 : 本内容仅限于浙江农林大学悦动together项目组内部传阅，禁止外泄
 */
@Controller
public class RefusedJoinTeamController {

	@Resource(name="refusedJoinTeamService")
	private RefusedJoinTeamService rjts;
	...
	public Map<String, Object> refusedJoinTeam(HttpServletRequest request, HttpServletResponse response){
		...
		try {
			rjts.refusedJoinTeam(team_id, user_id);
		} catch (Exception e) {

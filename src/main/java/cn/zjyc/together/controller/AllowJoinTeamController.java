...
/**
 * 
 * @ClassName: AllowJoinTeamController
 * @Description:同意加入队伍表示层
 * @author: while_box
 * @date: 2017年9月22日 上午10:00:19
 * 注意 : 本内容仅限于浙江农林大学悦动together项目组内部传阅，禁止外泄
 */
@Controller
public class AllowJoinTeamController {

	@Resource(name = "allowJoinTeamService")
	private AllowJoinTeamService ajts;
	...
	public Map<String, Object> allowJoinTeam(HttpServletRequest request, HttpServletResponse response){
		...
		try {
			ajts.allowJoinTeam(team_id, user_id);
		} catch (Exception e) {

...
public class ConverterUtil {
	...
	/**
	 * 将obj转换为double类型，如果出错则返回 defaultVal
	 * 
	 * @param obj
	 *            需要转换的对象
	 * @param defaultVal
	...
	/**
	 * 将obj转换为Timestamp类型，如果出错则返回 defaultVal
	 * @param obj
	 *            需要转换的对象
	 * @param defaultVal
	 *            默认值
	 * @return 转换后的结果
	 */
	public static Timestamp toTimestamp(Object obj,Timestamp defaultVal){
		try {
	...
	/**
	 * 将obj转换为Timestamp类型，如果出错则返回 null
	 * @param obj
	 *            需要转换的对象
	 * @return 转换后的结果
	 */
